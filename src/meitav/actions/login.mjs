...
export async function doMeitavLogin(idNumber, phoneNumber) {
  ...
  for (const f of [
    `${SCREENSHOT_DIR}/screenshot-01-page-loaded.png`,
    `${SCREENSHOT_DIR}/screenshot-02-credentials-filled.png`,
    `${SCREENSHOT_DIR}/screenshot-03-otp-screen.png`,
    `${SCREENSHOT_DIR}/screenshot-04-otp-filled.png`,
    `${SCREENSHOT_DIR}/screenshot-05-authenticated.png`,
    `${SCREENSHOT_DIR}/screenshot-resend.png`,
  ]) {
  ...
  await page.screenshot({ path: `${SCREENSHOT_DIR}/screenshot-01-page-loaded.png`, fullPage: true });
  console.log(`Screenshot saved: ${SCREENSHOT_DIR}/screenshot-01-page-loaded.png`);
  writeFileSync(`${SCREENSHOT_DIR}/dom-01-page-loaded.html`, await page.content(), 'utf-8');
  console.log(`DOM saved: ${SCREENSHOT_DIR}/dom-01-page-loaded.html`);
  ...
  await page.screenshot({ path: `${SCREENSHOT_DIR}/screenshot-02-credentials-filled.png`, fullPage: true });
  console.log(`Screenshot saved: ${SCREENSHOT_DIR}/screenshot-02-credentials-filled.png`);
  writeFileSync(`${SCREENSHOT_DIR}/dom-02-credentials-filled.html`, await page.content(), 'utf-8');
  console.log(`DOM saved: ${SCREENSHOT_DIR}/dom-02-credentials-filled.html`);
  ...
  await page.screenshot({ path: `${SCREENSHOT_DIR}/screenshot-03-otp-screen.png`, fullPage: true });
  console.log(`Screenshot saved: ${SCREENSHOT_DIR}/screenshot-03-otp-screen.png`);
  writeFileSync(`${SCREENSHOT_DIR}/dom-03-otp-screen.html`, await page.content(), 'utf-8');
  console.log(`DOM saved: ${SCREENSHOT_DIR}/dom-03-otp-screen.html`);
