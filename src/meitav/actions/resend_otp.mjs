...
export async function doMeitavResend(page) {
  ...
  await page.screenshot({ path: `${SCREENSHOT_DIR}/screenshot-resend.png`, fullPage: true });
  console.log(`Screenshot saved: ${SCREENSHOT_DIR}/screenshot-resend.png`);
  writeFileSync(`${SCREENSHOT_DIR}/dom-resend.html`, await page.content(), 'utf-8');
  console.log(`DOM saved: ${SCREENSHOT_DIR}/dom-resend.html`);
